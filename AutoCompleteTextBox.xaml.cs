    ...
    public partial class AutoCompleteTextBox : UserControl
    {
        ...
        private void DeleteCommaDelimitedSection()
        {
            try
            {
                string text = GetTextEditorText();
                int caretPosition = GetTextEditorCaretPosition();
                var (formattedText, newCaretPosition) = SD.Yuzu.Helpers.TestableHelper.DeleteCommaDelimitedSectionCore(text, caretPosition);
                SetTextEditorText(formattedText);
                SetTextEditorCaretPosition(newCaretPosition);
                _isUpdatingText = true;
                try
                {
                    Text = formattedText;
